...
//
//public interface TaskHistoryRepository extends PersistentRepository<TaskHistory, Long> {
//
//    public static final String NAMESPACE = TaskHistoryRepository.class.getName();
//
//    List<TaskHistory> selectByIdentifier(String identifier);
//
//    TaskHistory selectById(long id);
//
//    TaskHistory selectByTaskIdAndIdentifier(String identifier, String task_id);
//
