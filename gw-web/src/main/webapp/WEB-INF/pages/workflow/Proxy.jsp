...
<div id="proxy" name="propertyWindow" class="modal fade" tabindex="-1" role="dialog"
            ...
            <div class="modal-body">
                ...
                <div class="tab-v2">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#proxy-1" data-toggle="tab">Label</a></li>
                        <li class=""><a href="#proxy-2" data-toggle="tab">Embedded</a></li>
                        <li class=""><a href="#proxy-3" data-toggle="tab" name="scriptTab">Script</a></li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane fade in active" id="proxy-1">
                            <div class="row">
                                <div class="col-md-12">
                        ...
                        <div class="tab-pane fade in" id="proxy-2">
                            <div class="row">
                                <div class="col-md-12">
                        ...
                        <div class="tab-pane fade in" id="proxy-3">
                            <div class="row">
                                <div class="col-md-12">
                                    <form name="propertyForm" action="#" class="form-horizontal" role="form">
